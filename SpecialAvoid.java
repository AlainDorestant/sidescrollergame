...
public class SpecialAvoid extends Avoid{
    ...
    private static final String SAVOID_IMAGE_FILE = "media_files/greenzombie.png";

    //Dimensions of the Avoid  
    private static final int SAVOID_WIDTH = 100;
    private static final int SAVOID_HEIGHT = 100;
