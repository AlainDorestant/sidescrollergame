...
public class SpecialCollect extends Collect{
    ...
    private static final String SCOLLECT_IMAGE_FILE = "media_files/blaster.png";

    //Dimensions of the Collect  
    private static final int SCOLLECT_WIDTH = 100;
    private static final int SCOLLECT_HEIGHT = 100;
